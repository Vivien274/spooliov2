        ...
        <div className="flex flex-col md:flex-row items-start justify-between gap-8 pb-8 border-b border-white/10">
          ...
          <div className="flex flex-col gap-3 font-sans">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12.525.02c1.31-.032 2.61-.019 3.91-.019.08 1.54.89 2.91 2.22 3.63.78.43 1.66.64 2.54.68V8.16a7.28 7.28 0 01-4.04-1.29v7.1c0 1.25-.33 2.45-.98 3.5-1.4 2.27-4 3.56-6.68 3.19-2.63-.36-4.8-2.31-5.34-4.91-.74-3.56 1.5-7.07 5.09-7.75.46-.08.93-.12 1.4-.12.06 1.62.03 3.24.03 4.87-.97-.04-1.95.27-2.65 1.01-.89 1-.78 2.65.25 3.52.83.69 2.06.72 2.92.08.57-.42.86-1.12.87-1.82V.02z" />
                </svg>
              </a>
