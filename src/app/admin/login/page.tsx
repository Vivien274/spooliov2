      ...
      <div className="relative w-full max-w-md bg-[#131316]/80 border border-[#222225] rounded-[32px] p-8 md:p-10 shadow-2xl backdrop-blur-md flex flex-col items-center">
        ...
        <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full h-12 flex items-center justify-center text-sm font-bold text-black bg-white hover:bg-white/90 disabled:bg-white/50 rounded-xl transition-all shadow-lg shadow-white/5 hover:scale-[1.01] active:scale-[0.99] disabled:scale-100 cursor-pointer disabled:cursor-not-allowed text-center"
          >
            {loading ? (
