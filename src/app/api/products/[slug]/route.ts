...
function mapProduct(p: any) {
  ...
  return {
    ...
    metaTitleEn: p.metaTitleEn || p.meta_title_en || null,
    metaDescriptionEn: p.metaDescriptionEn || p.meta_description_en || null,
...
export async function PUT(
  ...
  try {
    ...
    const updateData: any = {
      name: body.name,
      nameEn: body.nameEn || body.name_en || null,
      price: effectivePrice || "0.00",
      regularPrice: body.regularPrice || effectivePrice || "0.00",
      salePrice: body.salePrice || null,
      onSale: body.onSale || false,
      shortDescription: body.shortDescription || null,
      shortDescriptionEn: body.shortDescriptionEn || body.short_description_en || null,
      description: body.description || null,
      descriptionEn: body.descriptionEn || body.description_en || null,
      ...
      metaTitleEn: body.metaTitleEn || body.meta_title_en || null,
      metaDescription: body.metaDescription || null,
      metaDescriptionEn: body.metaDescriptionEn || body.meta_description_en || null,
